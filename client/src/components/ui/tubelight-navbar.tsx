        ...
        {items.map((item) => {
          ...
          return (
            <a
              ...
              className={cn(
                "relative cursor-pointer text-sm font-semibold px-3 sm:px-6 py-2 rounded-full transition-all group",
                "text-foreground/80",
            ...
            >
              ...
              {/* Hover underline */}
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 w-0 bg-primary transition-all duration-300 group-hover:w-3/4"></span>
