        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/80">
              <li><a href="#" className="hover:text-background transition-colors" data-testid="link-footer-wealth">Wealth Management</a></li>
              <li><a href="#" className="hover:text-background transition-colors" data-testid="link-footer-investment">Investment Management</a></li>
              <li><a href="#" className="hover:text-background transition-colors" data-testid="link-footer-retirement">Retirement Planning</a></li>
              <li><a href="#" className="hover:text-background transition-colors" data-testid="link-footer-tax">Tax Strategies</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-background/80">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:6045889688" className="hover:text-background transition-colors" data-testid="link-footer-phone">
                  (604) 588-9688
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 flex-shrink-0" />
                <a href="mailto:info@westgroupfinancial.com" className="hover:text-background transition-colors" data-testid="link-footer-email">
